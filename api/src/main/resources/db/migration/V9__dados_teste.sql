begin;
    ...
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('adm empresa 1','adm_emp_1@empresa1.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_EMPRESA"}',6);
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('adm estab 1','adm-estab1@estab1.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_ESTABELECIMENTO"}',7);
    ...
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('adm empresa 2','adm_emp_2@empresa2.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_EMPRESA"}',9);
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('adm estab 2','adm-estab2@gmail.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_ESTABELECIMENTO"}',10);
