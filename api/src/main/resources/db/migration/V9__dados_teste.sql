begin;
    ...
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('carlos','carlos@gmail.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_EMPRESA"}',6);
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('maria','maria@gmail.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_ESTABELECIMENTO"}',7);
    ...
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('fernanda','fernanda@gmail.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_EMPRESA"}',9);
    insert into usuario(nome,email,senha,permissoes,endereco_id) values('vilmar','vilmar@gmail.com','$2a$11$NN91Lz01NlKX5XFfJ186PO6q21lZN0bp8ZyljHENUFjhB5z5b8mXa','{"ADMIN_ESTABELECIMENTO"}',10);
