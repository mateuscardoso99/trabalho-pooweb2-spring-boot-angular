...
class MapaPageState extends State<MapaPage> {
  ...
  @override
  void initState() {
    //roda quando o componente é carregado
    super.initState();
                ...
                onChanged: (value) {
                  if (value.length > 2) {
                    ...
                    setState(() => searchOnStoppedTyping =
                        Timer(duration, () => getCidades(value)));
                  }
                },
              ...
              Expanded(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                            onTap: () => {getEstabelecimentos(cidades[index])},
              ...
              child: FractionallySizedBox(
                  ...
                  child: (currentPosition != null)
                            ...
                            if (snapshot.connectionState ==
                              ...
                              if (jaPesquisouCidade) {
                                return Mapa(
                                    latLng: LatLng(
                                        double.parse(
                                            estabs[0].endereco.latitude ?? ''),
                                        double.parse(
                                            estabs[0].endereco.longitude ??
                                                '')),
                      ...
                      : Center(
                          ...
                          child: const Text("CARREGAR LOCALIZAÇÃO",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold)),
                        ))),
        ...
        return showDialog(
            ...
            builder: (context) {
              return const AlertDialog(
                  title: Text("Atenção"), content: Text("Ative a localização"));
            });
      }
    }
          ...
          return showDialog(
              ...
              builder: (context) {
                return const AlertDialog(
                    title: Text("Atenção"),
                    content: Text(
                        "Este aplicatvio precisa da permissão de localização"));
              });
        }
      }
    }
